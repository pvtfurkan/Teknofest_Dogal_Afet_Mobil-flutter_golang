...
class _SafeHomeState extends State<SafeHome> {
  ...
  checkGetHomeActivated() async {
    ...
    setState(() {
      getHomeSafeActivated = box.read("getHomeSafe") ?? false;
    });
  }
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        title: Text("Güvende misiniz ?"),
                        subtitle: Text("Konumunuzu Her 15 Dakikada Bir Paylaşın"),
                      ),
                      Visibility(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: SwitchListTile(
                        ...
                        subtitle: Text(
                            "Konumunuz her 15 dakikada bir acil durum kişilerinizle paylaşılacaktır."),
                      ),
                    ),
                    Expanded(
                        child: FutureBuilder(
                              ...
                              if (snapshot.hasData &&
                                ...
                                return ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      dynamic contactData = snapshot.data[index];
                                      return ListTile(
                                        onTap: () {
                                          setModalState(() {
                                ...
                                return ListTile(
                                  ...
                                  title: Text("Kişi bulunamadı!"),
                                  subtitle:
                                  Text("En az bir kişi seçiniz."),
                                  trailing: Icon(
